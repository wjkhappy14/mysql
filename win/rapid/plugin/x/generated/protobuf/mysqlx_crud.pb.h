...
class CreateView : public ::google::protobuf::Message {
 public:
  CreateView();
  virtual ~CreateView();
  ...
  inline void clear_definer();
  static const int kDefinerFieldNumber = 2;
  inline const ::std::string& definer() const;
  inline void set_definer(const ::std::string& value);
  inline void set_definer(const char* value);
  inline void set_definer(const char* value, size_t size);
  inline ::std::string* mutable_definer();
  inline ::std::string* release_definer();
  inline void set_allocated_definer(::std::string* definer);
  ...
  inline ::Mysqlx::Crud::ViewAlgorithm algorithm() const;
  inline void set_algorithm(::Mysqlx::Crud::ViewAlgorithm value);
  ...
  inline ::Mysqlx::Crud::ViewSqlSecurity security() const;
  inline void set_security(::Mysqlx::Crud::ViewSqlSecurity value);
  ...
  inline ::Mysqlx::Crud::ViewCheckOption check() const;
  inline void set_check(::Mysqlx::Crud::ViewCheckOption value);
  ...
  inline const ::Mysqlx::Crud::Find& stmt() const;
  inline ::Mysqlx::Crud::Find* mutable_stmt();
  inline ::Mysqlx::Crud::Find* release_stmt();
  inline void set_allocated_stmt(::Mysqlx::Crud::Find* stmt);

  // optional bool replace_existing = 8 [default = false];
  inline bool has_replace_existing() const;
  inline void clear_replace_existing();
  static const int kReplaceExistingFieldNumber = 8;
  inline bool replace_existing() const;
  inline void set_replace_existing(bool value);

  // @@protoc_insertion_point(class_scope:Mysqlx.Crud.CreateView)
 private:
  inline void set_has_collection();
  inline void clear_has_collection();
  inline void set_has_definer();
  inline void clear_has_definer();
  ...
  inline void set_has_replace_existing();
  inline void clear_has_replace_existing();
  ...
  void InitAsDefaultInstance();
  static CreateView* default_instance_;
};
// -------------------------------------------------------------------

class ModifyView : public ::google::protobuf::Message {
 public:
  ModifyView();
  virtual ~ModifyView();
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ModifyView* default_instance_;
};
// -------------------------------------------------------------------

class DropView : public ::google::protobuf::Message {
 public:
  DropView();
  virtual ~DropView();
  ...
  inline bool has_if_exists() const;
  inline void clear_if_exists();
  static const int kIfExistsFieldNumber = 2;
  inline bool if_exists() const;
  inline void set_if_exists(bool value);

  // @@protoc_insertion_point(class_scope:Mysqlx.Crud.DropView)
 private:
  inline void set_has_collection();
  inline void clear_has_collection();
  inline void set_has_if_exists();
  inline void clear_has_if_exists();
  ...
  void InitAsDefaultInstance();
  static DropView* default_instance_;
};
// ===================================================================
...
inline void CreateView::set_definer(const ::std::string& value) {
  set_has_definer();
  if (definer_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    definer_ = new ::std::string;
  }
  definer_->assign(value);
...
inline void CreateView::set_definer(const char* value, size_t size) {
  ...
  definer_->assign(reinterpret_cast<const char*>(value), size);
...
inline const ::Mysqlx::Crud::Find& CreateView::stmt() const {
  ...
  return stmt_ != NULL ? *stmt_ : *default_instance_->stmt_;
}
inline ::Mysqlx::Crud::Find* CreateView::mutable_stmt() {
  set_has_stmt();
  if (stmt_ == NULL) stmt_ = new ::Mysqlx::Crud::Find;
...
template <> struct is_proto_enum< ::Mysqlx::Crud::ViewAlgorithm> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Mysqlx::Crud::ViewAlgorithm>() {
  return ::Mysqlx::Crud::ViewAlgorithm_descriptor();
}
template <> struct is_proto_enum< ::Mysqlx::Crud::ViewSqlSecurity> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Mysqlx::Crud::ViewSqlSecurity>() {
  return ::Mysqlx::Crud::ViewSqlSecurity_descriptor();
}
template <> struct is_proto_enum< ::Mysqlx::Crud::ViewCheckOption> : ::google::protobuf::internal::true_type {};
template <>
