...
const ClientMessages_Type ClientMessages_Type_Type_MAX = ClientMessages_Type_CRUD_DROP_VIEW;
...
class ClientMessages : public ::google::protobuf::Message {
 public:
  ...
  static const Type CRUD_CREATE_VIEW = ClientMessages_Type_CRUD_CREATE_VIEW;
  static const Type CRUD_MODIFY_VIEW = ClientMessages_Type_CRUD_MODIFY_VIEW;
  static const Type CRUD_DROP_VIEW = ClientMessages_Type_CRUD_DROP_VIEW;
