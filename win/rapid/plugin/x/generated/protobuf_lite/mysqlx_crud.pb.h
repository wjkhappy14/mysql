...
class CreateView : public ::google::protobuf::MessageLite {
 public:
  CreateView();
  virtual ~CreateView();
...
class ModifyView : public ::google::protobuf::MessageLite {
 public:
  ModifyView();
  virtual ~ModifyView();
...
class DropView : public ::google::protobuf::MessageLite {
 public:
  DropView();
  virtual ~DropView();
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return stmt_ != NULL ? *stmt_ : *default_instance().stmt_;
#else
